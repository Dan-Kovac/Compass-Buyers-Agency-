...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'featured_image', title: 'Featured Image URL (legacy)', type: 'url', hidden: true }),
    ...
    defineField({ name: 'gallery_images', title: 'Gallery Image URLs (legacy)', type: 'array', of: [{ type: 'url' }], hidden: true }),
  ],
  preview: {
