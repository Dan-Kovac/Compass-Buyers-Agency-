...
await upsert({
  ...
  heading: 'Areas We Serve',
  subtitle: 'Compass Buyers Agency services buyers across the Tweed Coast, the Gold Coast and Byron Shire. We help you find and secure property in any of these suburbs.',

  shires: [
    {
      _key: 'sh-1', title: 'Tweed Coast',
      suburbs: [
        { _key: 's-1-1', name: 'Kingscliff', isLive: false },
        { _key: 's-1-2', name: 'Cabarita Beach', isLive: false },
        { _key: 's-1-3', name: 'Casuarina', isLive: false },
        { _key: 's-1-4', name: 'Pottsville', isLive: false },
        { _key: 's-1-5', name: 'Tweed Heads', isLive: false },
        { _key: 's-1-6', name: 'Murwillumbah', isLive: false },
      ],
    },
    {
      _key: 'sh-2', title: 'Gold Coast',
      suburbs: [
        { _key: 's-2-1', name: 'Currumbin', isLive: false },
        { _key: 's-2-2', name: 'Palm Beach', isLive: false },
        { _key: 's-2-3', name: 'Tallebudgera', isLive: false },
        { _key: 's-2-4', name: 'Burleigh Heads', isLive: false },
        { _key: 's-2-5', name: 'Miami', isLive: false },
        { _key: 's-2-6', name: 'Mermaid Beach', isLive: false },
      ],
    },
    {
      _key: 'sh-3', title: 'Byron Shire',
      suburbs: [
        { _key: 's-3-1', name: 'Byron Bay', isLive: true, slug: 'byron-bay-market-update' },
        { _key: 's-3-2', name: 'Bangalow', isLive: false },
        { _key: 's-3-3', name: 'Brunswick Heads', isLive: true, slug: 'brunswick-heads-profile' },
        { _key: 's-3-4', name: 'Mullumbimby', isLive: false },
        { _key: 's-3-5', name: 'Suffolk Park', isLive: false },
        { _key: 's-3-6', name: 'Ocean Shores', isLive: false },
      ],
    },
    {
      _key: 'sh-4', title: 'Ballina Shire',
      suburbs: [
        { _key: 's-4-1', name: 'Ballina', isLive: false },
        { _key: 's-4-2', name: 'Lennox Head', isLive: false },
        { _key: 's-4-3', name: 'Alstonville', isLive: false },
        { _key: 's-4-4', name: 'Wollongbar', isLive: false },
        { _key: 's-4-5', name: 'Cumbalum', isLive: false },
        { _key: 's-4-6', name: 'Skennars Head', isLive: false },
      ],
    },
  ],
...
await upsert({
  ...
  body: [
    ...
    { _key: 'b-10', _type: 'block', style: 'normal', children: [{ _key: 's-10', _type: 'span', text: 'You may request access to, correction of, or deletion of your personal information at any time by contacting us at hello@compassbuyersagency.com.au or calling 0467 634 565.' }] },
