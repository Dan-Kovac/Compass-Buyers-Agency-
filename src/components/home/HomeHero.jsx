...
export default function HomeHero({ title, subtitle, backgroundImageUrl, backgroundVideoUrl, ctaHref, ctaText } = {}) {
  ...
  return (
    <section className="relative min-h-[60vh] md:min-h-[78vh] flex items-center overflow-hidden mx-3 sm:mx-4 md:mx-6 lg:mx-8 mt-2 md:mt-5" style={{ borderRadius: 'var(--radius-xl)' }}>
      {/* Background */}
      {(backgroundVideoUrl || brand?.hero_background_video_url) ? (
            <video
      ...
      <div className="relative z-10 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
          <div className="max-w-3xl" style={{ "--h1-mb": "20px" }}>
            ...
            <div className="mt-4">
              <a href={ctaHref || createPageUrl("Contact")} className="inline-flex items-center text-white/95 hover:text-white underline underline-offset-4 decoration-white/50 hover:decoration-white">
