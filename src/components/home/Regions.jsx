  ...
  return (
    <section className="py-14 md:py-20 bg-white">
      <div className="site-container">
        <h2 className="text-center mb-4">Areas We Serve</h2>
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">We specialise in Northern NSW & Southern QLD
Byron Shire, Tweed Shire and the City of Gold Coast. We're across council rules and overlays in each region and stay in tune with the latest information as it relates to your investment.
