      ...
      <section className="bg-white" style={{ padding: "var(--section-breathing) 0" }}>
        <div className="site-container">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start max-w-5xl mx-auto">
            ...
            <ScrollReveal animation="fade-right">
              <div className="space-y-8">
                ...
                <a href={`tel:${phoneRaw}`} className="flex items-start gap-4 group">
                  <Phone className="w-6 h-6 text-[var(--hills)] shrink-0 mt-0.5" />
                  <div>
                    <div className="eyebrow-label" style={{ marginBottom: "4px" }}>Mobile</div>
                    <div
                ...
                <a href={`mailto:${email}`} className="flex items-start gap-4 group">
                  <Mail className="w-6 h-6 text-[var(--hills)] shrink-0 mt-0.5" />
                  <div>
                    <div className="eyebrow-label" style={{ marginBottom: "4px" }}>Email</div>
                    <div
                ...
                <div className="flex items-start gap-4">
                  <MapPin className="w-6 h-6 text-[var(--hills)] shrink-0 mt-0.5" />
                  <div>
                    <div className="eyebrow-label" style={{ marginBottom: "4px" }}>Office</div>
                ...
                {/* Divider */}
                <hr className="border-[var(--bright-grey)]" />
                ...
                {/* Social */}
                <div>
                  <div className="eyebrow-label" style={{ marginBottom: "12px" }}>Follow Us</div>
                  <div className="flex items-center gap-4">
                    <a
                      href="https://www.instagram.com/compassbuyersagency"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-full border border-[var(--bright-grey)] flex items-center justify-center hover:bg-[var(--hills)] hover:border-[var(--hills)] hover:text-white text-[var(--stone)] transition-all"
            ...
            <ScrollReveal animation="fade-left" delay={120} id="enquiry-form">
              <div className="bg-sand-wash rounded-xl p-6 md:p-8">
                <ContactFormCompact
